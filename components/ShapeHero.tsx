                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <br />
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-300 via-white/90 to-violet-300 ">
                                {title2}
                            </span>
                        </h1>
                    </motion.div>
